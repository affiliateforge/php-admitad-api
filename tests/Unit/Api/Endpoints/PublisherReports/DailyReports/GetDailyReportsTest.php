...
use Affiliateforge\PhpAdmitadApi\Api\Endpoints\PublisherReports\DailyReports\GetDailyReports;
use Affiliateforge\PhpAdmitadApi\Api\Endpoints\PublisherReports\DailyReports\GetDailyReportsResponse;
use Nyholm\Psr7\Factory\Psr17Factory;
use PHPUnit\Framework\TestCase;

class GetDailyReportsTest extends TestCase
{
    public function testEndpointConfiguration()
    {
        $dto = new GetDailyReports(
            offset: 1,
            limit: 2,
        ...
        $this->assertSame('/statistics/dates/', $dto->getUrlPath());
        ...
        $this->assertInstanceOf(GetDailyReportsResponse::class, $dto->makeResponseDTO($mockResponse));
    }
}