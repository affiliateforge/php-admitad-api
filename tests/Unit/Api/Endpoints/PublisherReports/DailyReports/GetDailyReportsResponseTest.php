...
namespace Tests\Unit\Api\Endpoints\PublisherReports\DailyReports;
...
JSON;
        ...
        $this->assertEquals('2021-15-01', $report->getDate());
        $this->assertSame(0, $report->getViews());
        $this->assertSame(117, $report->getClicks());
