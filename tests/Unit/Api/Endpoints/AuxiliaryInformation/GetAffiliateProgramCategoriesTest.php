...
use Affiliateforge\PhpAdmitadApi\Api\Endpoints\AuxiliaryInformation\GetAffiliateProgramCategories;
use Affiliateforge\PhpAdmitadApi\Api\Endpoints\AuxiliaryInformation\GetAffiliateProgramCategoriesResponse;
use Nyholm\Psr7\Factory\Psr17Factory;
use PHPUnit\Framework\TestCase;

class GetAffiliateProgramCategoriesTest extends TestCase
{
    public function testEndpointConfiguration()
    {
        $dto = new GetAffiliateProgramCategories(
            offset: 4,
            limit: 1,
            campaign: 777,
            language: 'en',
        ...
        $this->assertSame('/categories/', $dto->getUrlPath());
